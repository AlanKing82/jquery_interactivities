// $Rev: 7446 $ $Date: 2016-03-01 15:36:50 +0000 (Tue, 01 Mar 2016) $ $Author: jan $
var _Debug = !1,
    _Offline = !0,
    _NoError = 0,
...
function onFrameLoad() {
    ...
    pause();
    showLessonMessage();
    currentScreenNo == noOfScreens && 0 === $("a#policy-link", a.document).length && lastScreenCompletion(a.lessonQuestionsEnabled);
...
function lastScreenCompletion(lessonQuestionsEnabled) {
    
    if(!lessonQuestionsEnabled){
        console.log('on last screen fire');
...
function goToBookmark(a, b) {
    ...
    currentScreenNo == noOfScreens && ($("#next_link").attr("class", "navigationButton buttonExit"), onLastScreen());
    refreshCounter()
}
...
function onLastScreen() {
    ...
    if(frames.myFrame.lessonQuestionsEnabled){return false}
